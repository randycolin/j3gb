...
//设置好以下三项查询条件,得都输入
$tiaojian1="卦象";			//查询条件1列标题，跟excel列头一致，注意无空格;

$UpDir="liuyao";			//设置数据库所在目录(文件夹名称)请修改，修改后更名对应文件夹。
$title="剑网叁[道长]占卜系统";			//设置查询标题,相信你懂的。
$copyr="笑傲江湖[道长]帮会";				//设置底部版权文字,相信你懂的。
$copyu="http://www.j3gb.com/";			//设置底部版权连接,相信你懂的。
