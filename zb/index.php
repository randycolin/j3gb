...
<div class="so_boxed" id="tishi">说明:【<?php echo $tiaojian1;?>+验证码】都输入正确才显示相应结果。</div>
<div id="tishi1" style="display:none;">请认真输入玩家占卜的<?php echo $tiaojian1;?></div>
<div id="tishi4" style="display:none;">输入4数字验证码</div>
</form>
<?php
}else{
